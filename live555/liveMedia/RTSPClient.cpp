...
unsigned RTSPClient::sendSetupCommand(MediaSubsession& subsession, responseHandler* responseHandler,
                      ...
                      Authenticator* authenticator,Boolean fullResult) {
...
void RTSPClient::handleResponseBytes(int newBytesRead) {
  ...
  do {
    ...
    do {
      ...
      //resCopy = new char[responseBufferSize];
       //strncpy(resCopy, fResponseBuffer, fResponseBytesAlreadySeen);
      // resCopy[fResponseBytesAlreadySeen] = '\0';
      char* lineStart;
